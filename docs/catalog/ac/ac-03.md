...
<em>[Withdrawn; incorporated into [AC-6](/catalog/ac/ac-06#ac-06).]</em>
...
<em>[Withdrawn; incorporated into [MP-4](/catalog/mp/mp-04#mp-04); incorporated into [SC-28](/catalog/sc/sc-28#sc-28).]</em>
...
<details><summary>Supplemental Guidance</summary>In certain situations, such as when there is a threat to human life or an event that threatens the organization’s ability to carry out critical missions or business functions, an override capability for access control mechanisms may be needed. Override conditions are defined by organizations and used only in those limited circumstances. Audit events are defined in [AU-2](/catalog/au/au-02#au-02) . Audit records are generated in [AU-12](/catalog/au/au-12#au-12).</details>
